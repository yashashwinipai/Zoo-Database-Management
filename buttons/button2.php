...
<h1 style="color:black;">Caretaker DATABASE</h1>

<h2 style="color:black; padding-top: 10px">For SPECIFIC caretakers click here:<h2>

<form action="new1.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<h2 style="color:black;">All caretakers<h2>

<form action="nc.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>
<h2 style="color:black;">incharge record<h2>

<form action="ny.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<body style = "background : url(https://images.unsplash.com/photo-1588506230603-51f7ad9eb133?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1066&q=80);background-size:cover ">
  <h2 style="color:black;">ADD to database<h2>
    <button onclick="location.href='c2.html'" button class="btn btn-secondary">Add</button>
    <div class="backbutton">
        <form action="staff.php">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
