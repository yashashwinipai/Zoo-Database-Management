...
<h1 style="color:WHITE;">SAFFARI DATABASE</h1>

<h2 style="color:WHITE;"> All Slots<h2>

<form action="all-slot.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<h2 style="color:WHITE;">All Booking<h2>

<form action="all-booking.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>
<h2 style="color:WHITE;">no slot booked<h2>

<form action="noslot.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>
<body style = "background : url(https://images.unsplash.com/photo-1604602236223-156a7f332bc4?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1050&q=80);background-size: cover; ">
  <h2 style="color:WHITE;">ADD to database<h2>
    <button onclick="location.href='add-slot.html'" button class="btn btn-secondary">Add</button>
</html>
</body>
