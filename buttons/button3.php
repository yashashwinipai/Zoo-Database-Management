...
<h1 style="color:white;">VET DATABASE</h1>

<h2 style="color:WHITE;">For SPECIFIC vets click here:<h2>

<form action="new3.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<h2 style="color:WHITE;">All vets<h2>

<form action="nv.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>
<h2 style="color:WHITE;">ongoing treatment<h2>

<form action="sp.php">
<button type="submit" class="btn btn-secondary">Submit</button></form>

<body style = "background : url(https://images.unsplash.com/photo-1597214840472-aa1eaf0e1fac?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80);background-size: cover ">
  <h2 style="color:WHITE;">ADD to database<h2>
    <button onclick="location.href='v2.html'" button class="btn btn-secondary">Add</button>
 </html>
</html>
</body>
